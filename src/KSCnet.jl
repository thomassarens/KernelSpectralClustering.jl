function kscnet(network_file::String, file_dir::String, file_name::String, delimiter::Char; fraction=0.15::Float64, method="furs"::String, minK=2::Int, maxK=100::Int, eigfull=false::Bool, maxMB=4000::Int, metrics=false::Bool, convertF=true::Bool)
  if minK < 2 || minK > maxK
    error("kscnet function: minK must be at least 2 and smaller than maxK")
  end
  ...
  if metrics
    ...
    tic()
    modularityM = modularity2(fileCount, kBAF, fileWeighted)
    timeModularity = toq()
